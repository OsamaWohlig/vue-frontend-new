<template>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex justify-space-between md:text-left text-center order-first">
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <div class="flex xl:flex-nowrap md:flex-nowrap lg:flex-nowrap flex-wrap justify-center items-end md:justify-start">
